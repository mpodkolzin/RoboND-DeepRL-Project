...
#define GAMMA 0.9f
#define EPS_START 0.8f // Task 1 #define EPS_START 0.9f
#define EPS_END 0.01f // Task 1 #define EPS_END 0.05f
#define EPS_DECAY 300 // Task 1 #define EPS_DECAY 200
...
#define LEARNING_RATE 0.15f // Task 1 #define LEARNING_RATE 0.2f
#define REPLAY_MEMORY 10000
#define BATCH_SIZE 32 // Task 1 #define BATCH_SIZE 16
...
void ArmPlugin::OnUpdate(const common::UpdateInfo& updateInfo)
{
	...
	if( maxEpisodeLength > 0 && episodeFrames > maxEpisodeLength )
	{
		...
		rewardHistory = REWARD_LOSS; // T#1 rewardHistory = REWARD_LOSS * 1000.0f;
		newReward     = true;
		endEpisode    = true;
	}
